...
import {
  ValidationHandler,
  ValidationParams
} from '../token/tokenvalidationhandler';
...
import { b64DecodeUnicode, base64UrlEncode } from '../utilities/base64-helper';
import { AuthConfig } from './auth.config';
import { WebHttpUrlEncodingCodec } from '../utilities/encoder';
import { HashHandler } from '../token/hash-handler';
